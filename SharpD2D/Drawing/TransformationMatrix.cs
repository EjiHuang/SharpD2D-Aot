...
namespace SharpD2D.Drawing
{
    ...
    public struct TransformationMatrix
    {
        ...
        /// </summary>
        public PointF TranslationVector
        {
            get => new PointF(M31, M32);
            set
            {
                M31 = value.X;
                M32 = value.Y;
        ...
        /// </summary>
        public PointF ScaleVector
        {
            get => new PointF(M11, M22);
            set
            {
                M11 = value.X;
                M22 = value.Y;
        ...
        ///     Thrown when <paramref name="values" /> contains more or less than six
        ///     elements.
        /// </exception>
        ...
        /// </remarks>
        public static TransformationMatrix Lerp(ref TransformationMatrix start, ref TransformationMatrix end,
            float amount)
        {
            return new TransformationMatrix(
        ...
        /// <param name="end">End matrix.</param>
        /// <param name="amount">Value between 0 and 1 indicating the weight of <paramref name="end" />.</param>
        public static TransformationMatrix SmoothStep(ref TransformationMatrix start, ref TransformationMatrix end,
            float amount)
        {
        ...
        public static TransformationMatrix Scaling(ref PointF scale)
        {
        ...
        public static TransformationMatrix Scaling(PointF scale)
        {
        ...
        /// <returns>The created scaling matrix.</returns>
        public static TransformationMatrix Scaling(float x, float y, PointF center)
        {
            return new TransformationMatrix
            {
                M11 = x,
        ...
        public static TransformationMatrix Rotation(float angle, PointF center)
        {
            return Translation(new PointF(-center.X, -center.Y)) * Rotation(angle) * Translation(center);
        }
        ...
        public static TransformationMatrix Transformation(float xScale, float yScale, float angle, float xOffset,
            float yOffset)
        {
        ...
        public static TransformationMatrix Translation(ref PointF value)
        {
        ...
        public static TransformationMatrix Translation(PointF value)
        {
        ...
        public static PointF TransformPoint(TransformationMatrix matrix, PointF point)
        {
            PointF result;
        ...
        /// <param name="point">The original vector to apply the transformation.</param>
        /// <returns></returns>
        public static PointF TransformPoint(ref TransformationMatrix matrix, ref PointF point)
        {
            PointF localResult;
        ...
        public static TransformationMatrix Invert(ref TransformationMatrix value)
        {
            ...
            if (MathUtil.IsZero(determinant)) return Identity;
